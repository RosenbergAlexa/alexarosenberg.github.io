...
import capstone.controller.AuthenticationController;
...
public class Driver extends Application {
	...
	public void start( Stage primaryStage ) {
		...
		FXMLLoader userLogin = new FXMLLoader( getClass().getResource( "/view/userLogin.fxml" ) );
		
		try{
			
			Scene scene = new Scene( userLogin.load(), 640, 430 );
			AuthenticationController controller = userLogin.getController();
			stage.setScene( scene );
			stage.setOnHidden( _ -> controller.exitProgram() ); //Define what should happen if users click the OS close window button
			stage.show();
	...
	public void stop() throws Exception {
		...
		//TODO: Clean up any remaining async resources, LIKE THE DATABASE CONNECTION
